...
assert.strictEqual(Sim.canAdvance(chaosKing), false, '入圣是门槛，混沌也不能只靠无道蕴瓶颈跨过去');
chaosKing.saintPassed = true;
assert.strictEqual(Sim.canAdvance(chaosKing), true, '过了入圣门槛后，混沌无道蕴瓶颈');
