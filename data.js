...
(function (root) {
  ...
  /* zhx 直接加在证道成功率上。混沌体成帝是大概率不是保送，引擎里另有盖帽；
   * 先天圣体道胎仍近无瓶颈。不要按金卡量级去削这条。 */
  var PHYSIQUES = [
   ...
   *   2~4 世天皇    165~260 万 —— 压大帝，尚未稳压天帝
   *   5 世天皇      300 万     —— 与天帝相持
   *   8 世天皇      750 万     —— 未成仙，但已逼近红尘仙
   *   红尘仙        800 万     —— 标准红尘仙；成仙的不死天皇也是这一档
   *   天帝看战力不看世数：圣体 / 无始可以一世天帝，吃药进二世再悟道也能入此境
  ...
  var DATA = {
    ...
    /* 成仙路大约一百万年开一次；禁区至尊一生大约赶上两到三次。 */
    IMMORTAL_ROAD_PERIOD: 1000000,
    IMMORTAL_ROAD_MIN_YEAR: 1000000,
    IMMORTAL_ROAD_LORD_MAX: 3,
