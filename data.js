...
(function (root) {
  ...
  var TRAITS = [
    ...
    { id: 'w09', name: '温故知新', color: 'w', path: 'dao', fx: [['dao', 3], ['daog', 1.08]] },
    ...
    { id: 'w25', name: '留得青山', color: 'w', path: 'imperial', fx: [['retryKeep', 0.15], ['life', 6]] },
    ...
    { id: 'b06', name: '天资初醒', color: 'b', path: 'dao', fx: [['dao', 9], ['daog', 1.18]] },
    { id: 'b07', name: '底蕴渐丰', color: 'b', path: 'dao', fx: [['daocap', 60], ['daog', 1.18]] },
    { id: 'b08', name: '过目不忘', color: 'b', path: 'dao', fx: [['dao', 11], ['daocap', 40]] },
    { id: 'b09', name: '渐入佳境', color: 'b', path: 'dao', fx: [['daog', 1.22]] },
    { id: 'b10', name: '厚积薄发', color: 'b', path: 'dao', fx: [['overflow', 0.25], ['daocap', 32]] },
    ...
    { id: 'b20', name: '观天悟道', color: 'b', path: 'tianxin', fx: [['xinPity', 0.000012], ['daocap', 32]] },
    { id: 'b21', name: '命比金坚', color: 'b', path: 'imperial', fx: [['life', 18], ['ward', 3]] },
    { id: 'b22', name: '稳如磐石', color: 'b', path: 'imperial', fx: [['ward', 5], ['zhx', 0.02]] },
    { id: 'b23', name: '大器晚成', color: 'b', path: 'imperial', fx: [['life', 15], ['retryKeep', 0.25]] },
    { id: 'b24', name: '败而不馁', color: 'b', path: 'imperial', fx: [['retryKeep', 0.25], ['dao', 5], ['zhx', 0.02]] },
    ...
    { id: 'p17', name: '通神之窍', color: 'p', path: 'tianxin', fx: [['dlm', 20], ['dao', 16]] },
    ...
    { id: 'p23', name: '帝裔余荫', color: 'p', path: 'imperial', fx: [['zhx', 0.04], ['life', 35]] },
    ...
    { id: 'o16', name: '天心随行', color: 'o', path: 'tianxin', fx: [['xin', 2], ['xinPity', 0.00005]] },
