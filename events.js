...
(function (root) {
  ...
  var T3_HERB = ['紫耀铜精', '安魂铁', '红丝龙木', '血钻', '紫玉王', '银月神玉', '大罗银精', '九天赤玉王', '九天白玉璧', '羊脂白玉神铁', '太初命石', '紫云晶', '火精神汁', '辟火珠', '黄泉水'];
  ...
  var EVENTS = [
    ...
    /* ===================== tier 4 传说 ===================== */
    {
      ...
      name: '仙路坐标', tier: 4, desc: '古代至尊留下的奇异世界线索',
      minAge: 80, maxAge: 1000000,
      cond: null,
      ok: function (g, U) {
        g.knowsStrangeWorld = true;
        U.printlog('在一座残破仙府中寻得古代至尊手札，得知奇异世界真实存在，并掌握了界壁坐标！');
      },
      fail: null
    },
    {
